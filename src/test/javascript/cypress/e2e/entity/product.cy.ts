...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'drat hydrofoil', price: 27204.35, productSize: 'L' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: { name: 'dither', description: 'wardrobe steel' },
    }).then(({ body }) => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('without');
      cy.get(`[data-cy="name"]`).should('have.value', 'without');

      cy.get(`[data-cy="description"]`).type('yet borrower unless');
      cy.get(`[data-cy="description"]`).should('have.value', 'yet borrower unless');

      cy.get(`[data-cy="price"]`).type('15385.87');
      cy.get(`[data-cy="price"]`).should('have.value', '15385.87');
